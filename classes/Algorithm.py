...
class Tabu_Search(TabuSearch, RandomGreedy):
    ...
    def __init__(self, Max_It_RG, seed, system, Max_time_RG=0, K=1, besties_RG=None, log=Logger()):
        ...
        if besties_RG is None:
            best_result_no_update, elite, random_params = self.random_greedy(K=K, MaxIt=self.Max_It_RG,
                                                                             MaxTime=self.Max_time_RG)
    ...
    def run_TS(self, method, tabu_size, min_score, max_steps, Max_time=None):
        ...
        best_sol_info = [best_best_cost, best_best_solution, best_current_cost_list, best_best_cost_list,
                         best_time_list]
        Starting_points_info = [Starting_point_solutions, Starting_point_best_costs, Starting_point_current_cost_list,
                                Starting_point_best_cost_list, Starting_point_time_list]
...
class Genetic_algorithm(GeneticAlgorithm, RandomGreedy):
    ...
    #   @param system A System.System object
    #   @param log Object of Logger.Logger type
    def __init__(self, Max_It_RG, seed, crossover_rate, mutation_rate, max_steps, system, Max_time_RG=0, Max_time=None,
                 max_fitness=None, besties_RG=None, log=Logger()):
